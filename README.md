...
```
python finetune_summarization.py --model_id facebook/opt-125m --dataset beanham/medsum --input_col dialogue --target_col section_text --train_slice train --validation_slice validation --test_slice test --wandb_logging True --wandb_name --max_steps 500
```
